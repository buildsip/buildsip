...
6. Build a numbered list of markdown links, using each story's path as the link target, and then ask the user whether they'd like changes or want you to proceed with the upload. If a story includes a warning, note it next to the markdown link like this: "[title](link) — **⚠️ Privacy warning**".
